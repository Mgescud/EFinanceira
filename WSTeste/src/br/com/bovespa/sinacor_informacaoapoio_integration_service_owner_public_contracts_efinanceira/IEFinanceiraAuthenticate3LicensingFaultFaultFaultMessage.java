...
public class IEFinanceiraAuthenticate3LicensingFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IEFinanceiraAuthenticate3LicensingFaultFaultFaultMessage(String message, LicensingFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IEFinanceiraAuthenticate3LicensingFaultFaultFaultMessage(String message, LicensingFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
