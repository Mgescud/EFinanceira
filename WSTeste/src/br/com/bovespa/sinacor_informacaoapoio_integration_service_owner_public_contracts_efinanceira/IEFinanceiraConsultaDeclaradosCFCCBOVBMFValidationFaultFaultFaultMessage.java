...
public class IEFinanceiraConsultaDeclaradosCFCCBOVBMFValidationFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IEFinanceiraConsultaDeclaradosCFCCBOVBMFValidationFaultFaultFaultMessage(String message, ValidationFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IEFinanceiraConsultaDeclaradosCFCCBOVBMFValidationFaultFaultFaultMessage(String message, ValidationFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
