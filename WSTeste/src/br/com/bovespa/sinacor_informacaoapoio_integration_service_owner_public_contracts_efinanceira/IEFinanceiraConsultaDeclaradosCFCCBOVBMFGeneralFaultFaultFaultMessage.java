...
public class IEFinanceiraConsultaDeclaradosCFCCBOVBMFGeneralFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IEFinanceiraConsultaDeclaradosCFCCBOVBMFGeneralFaultFaultFaultMessage(String message, GeneralFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IEFinanceiraConsultaDeclaradosCFCCBOVBMFGeneralFaultFaultFaultMessage(String message, GeneralFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
