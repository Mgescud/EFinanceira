...
public class IEFinanceiraAuthenticateInvalidSessionFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IEFinanceiraAuthenticateInvalidSessionFaultFaultFaultMessage(String message, InvalidSessionFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IEFinanceiraAuthenticateInvalidSessionFaultFaultFaultMessage(String message, InvalidSessionFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
