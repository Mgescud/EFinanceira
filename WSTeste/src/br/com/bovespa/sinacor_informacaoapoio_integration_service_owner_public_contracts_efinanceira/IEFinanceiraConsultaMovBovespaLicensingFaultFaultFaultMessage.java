...
public class IEFinanceiraConsultaMovBovespaLicensingFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IEFinanceiraConsultaMovBovespaLicensingFaultFaultFaultMessage(String message, LicensingFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IEFinanceiraConsultaMovBovespaLicensingFaultFaultFaultMessage(String message, LicensingFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
