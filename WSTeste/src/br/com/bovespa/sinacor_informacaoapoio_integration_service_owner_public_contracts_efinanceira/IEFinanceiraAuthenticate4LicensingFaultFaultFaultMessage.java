...
public class IEFinanceiraAuthenticate4LicensingFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IEFinanceiraAuthenticate4LicensingFaultFaultFaultMessage(String message, LicensingFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IEFinanceiraAuthenticate4LicensingFaultFaultFaultMessage(String message, LicensingFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
