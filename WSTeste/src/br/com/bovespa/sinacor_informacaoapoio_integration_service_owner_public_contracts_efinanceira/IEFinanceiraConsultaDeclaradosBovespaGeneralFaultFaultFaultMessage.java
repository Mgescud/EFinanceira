...
public class IEFinanceiraConsultaDeclaradosBovespaGeneralFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IEFinanceiraConsultaDeclaradosBovespaGeneralFaultFaultFaultMessage(String message, GeneralFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IEFinanceiraConsultaDeclaradosBovespaGeneralFaultFaultFaultMessage(String message, GeneralFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
