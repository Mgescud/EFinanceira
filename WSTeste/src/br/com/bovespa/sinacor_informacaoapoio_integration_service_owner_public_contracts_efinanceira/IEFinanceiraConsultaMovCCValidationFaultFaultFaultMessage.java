...
public class IEFinanceiraConsultaMovCCValidationFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IEFinanceiraConsultaMovCCValidationFaultFaultFaultMessage(String message, ValidationFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IEFinanceiraConsultaMovCCValidationFaultFaultFaultMessage(String message, ValidationFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
