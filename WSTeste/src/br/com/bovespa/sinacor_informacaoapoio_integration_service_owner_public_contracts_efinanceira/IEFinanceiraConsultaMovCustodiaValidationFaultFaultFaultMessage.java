...
public class IEFinanceiraConsultaMovCustodiaValidationFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IEFinanceiraConsultaMovCustodiaValidationFaultFaultFaultMessage(String message, ValidationFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IEFinanceiraConsultaMovCustodiaValidationFaultFaultFaultMessage(String message, ValidationFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
