...
public class IEFinanceiraConsultaDeclaradoGeneralFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IEFinanceiraConsultaDeclaradoGeneralFaultFaultFaultMessage(String message, GeneralFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IEFinanceiraConsultaDeclaradoGeneralFaultFaultFaultMessage(String message, GeneralFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
