...
public class IEFinanceiraAuthenticate6ValidationFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IEFinanceiraAuthenticate6ValidationFaultFaultFaultMessage(String message, ValidationFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IEFinanceiraAuthenticate6ValidationFaultFaultFaultMessage(String message, ValidationFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
