...
public class IEFinanceiraConsultaMovCustodiaInvalidSessionFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IEFinanceiraConsultaMovCustodiaInvalidSessionFaultFaultFaultMessage(String message, InvalidSessionFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IEFinanceiraConsultaMovCustodiaInvalidSessionFaultFaultFaultMessage(String message, InvalidSessionFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
