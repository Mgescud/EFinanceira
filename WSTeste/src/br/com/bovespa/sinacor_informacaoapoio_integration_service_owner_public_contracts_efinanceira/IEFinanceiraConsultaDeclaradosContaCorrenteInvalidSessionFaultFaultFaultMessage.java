...
public class IEFinanceiraConsultaDeclaradosContaCorrenteInvalidSessionFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IEFinanceiraConsultaDeclaradosContaCorrenteInvalidSessionFaultFaultFaultMessage(String message, InvalidSessionFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IEFinanceiraConsultaDeclaradosContaCorrenteInvalidSessionFaultFaultFaultMessage(String message, InvalidSessionFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
