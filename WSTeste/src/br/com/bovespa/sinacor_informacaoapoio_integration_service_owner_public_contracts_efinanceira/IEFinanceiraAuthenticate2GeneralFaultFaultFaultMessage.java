...
public class IEFinanceiraAuthenticate2GeneralFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IEFinanceiraAuthenticate2GeneralFaultFaultFaultMessage(String message, GeneralFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IEFinanceiraAuthenticate2GeneralFaultFaultFaultMessage(String message, GeneralFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
