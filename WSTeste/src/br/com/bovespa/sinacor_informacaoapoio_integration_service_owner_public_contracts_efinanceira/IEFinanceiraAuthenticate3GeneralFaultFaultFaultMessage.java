...
public class IEFinanceiraAuthenticate3GeneralFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IEFinanceiraAuthenticate3GeneralFaultFaultFaultMessage(String message, GeneralFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IEFinanceiraAuthenticate3GeneralFaultFaultFaultMessage(String message, GeneralFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
