...
public class IEFinanceiraConsultaDeclaradosContaCorrenteLicensingFaultFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public IEFinanceiraConsultaDeclaradosContaCorrenteLicensingFaultFaultFaultMessage(String message, LicensingFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IEFinanceiraConsultaDeclaradosContaCorrenteLicensingFaultFaultFaultMessage(String message, LicensingFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
